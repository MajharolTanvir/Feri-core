...
//* Weight controller
const addWeight = (0, catchAsync_1.default)((req, res) =>
...
const getWeights = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const editWeight = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params
    const result = yield weight_services_1.WeightService.editWeight(
      req.body,
      id,
    )
    ;(0, sendResponse_1.default)(res, {
...
const deleteWeight = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params
