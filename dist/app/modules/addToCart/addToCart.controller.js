...
const createAddToCart = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield addToCart_services_1.AddToCartServices.createAddToCart(
      req.body,
    )
...
const getAddToCart = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteAddToCart = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield addToCart_services_1.AddToCartServices.deleteAddToCart(
      req.params.id,
    )
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
