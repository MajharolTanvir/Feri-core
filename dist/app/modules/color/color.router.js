...
router.patch(
  ...
  (0, validateRequest_1.default)(
    color_validation_1.ColorValidation.updateColorZodSchema,
  ),
  color_controller_1.ColorController.editColor,
)
router.get('/', color_controller_1.ColorController.getColors)
router.delete(
  '/:id',
  (0, auth_1.default)(users_1.ENUM_USER_ROLE.ADMIN),
  color_controller_1.ColorController.deleteColor,
)
router.post(
  '/',
  (0, auth_1.default)(
  ...
  (0, validateRequest_1.default)(
    color_validation_1.ColorValidation.createColorZodSchema,
  ),
  color_controller_1.ColorController.addColor,
)
