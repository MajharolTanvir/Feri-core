...
const createProduct = (userId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const createProducts = yield prisma_1.default.$transaction((transactionProduct) => __awaiter(void 0, void 0, void 0, function* () {
        const createProduct = yield transactionProduct.product.create({
            data: payload.product,
        });
        yield product_utils_1.ProductUtils.createProductWithDetails(createProduct.id, payload, transactionProduct);
...
const updateProduct = (id, userId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield product_utils_1.ProductUtils.updateProductWithDetails(isExistProduct, payload);
    return result;
});
