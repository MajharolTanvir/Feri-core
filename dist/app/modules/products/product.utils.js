...
const createProductWithDetails = (productId, payload, transactionProduct) =>
...
const updateProductWithDetails = (product, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const {
      colorConnection,
      sizeConnection,
