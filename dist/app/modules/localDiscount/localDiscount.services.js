...
const createLocalDiscount = (discountData, userId) => __awaiter(void 0, void 0, void 0, function* () {
    const { products } = discountData, data = __rest(discountData, ["products"]);
...
const allLocalDiscount = () => __awaiter(void 0, void 0, void 0, function* () {
...
const singleLocalDiscount = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteLocalDiscount = (id, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield prisma_1.default.promoCodeWithProduct.deleteMany({
        where: {
            localDiscountId: isDiscount === null || isDiscount === void 0 ? void 0 : isDiscount.id,
        },
    });
    return yield prisma_1.default.localDiscount.delete({
        where: {
            id: isDiscount === null || isDiscount === void 0 ? void 0 : isDiscount.id,
        },
    });
});
