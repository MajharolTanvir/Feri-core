...
router.post(
  ...
  (0, validateRequest_1.default)(
    feedback_validation_1.FeedbackValidation.createFeedback,
  ),
...
router.get(
  ...
  feedback_controller_1.FeedbackController.allFeedback,
)
router.get(
  '/:id',
  (0, auth_1.default)(
  ...
  feedback_controller_1.FeedbackController.singleFeedback,
)
router.delete(
  '/:id',
  (0, auth_1.default)(
