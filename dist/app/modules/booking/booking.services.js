...
const createBooking = (bookingData, userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { productIds } = bookingData,
      data = __rest(bookingData, ['productIds'])
    bookingData.buyerId = userId
    const result = yield prisma_1.default.booking.create({
      data,
    })
    productIds.map(productId =>
      prisma_1.default.productBooking.create({
        data: {
          bookingId: result.id,
          productId: productId,
        },
