...
router.post(
  ...
  (0, validateRequest_1.default)(tags_validation_1.TagsValidation.create),
  tags_controller_1.TagsController.createTags,
)
router.patch(
  '/:id',
  (0, auth_1.default)(
  ...
  tags_controller_1.TagsController.updateTags,
)
router.delete(
  '/:id',
  (0, auth_1.default)(
  ...
  tags_controller_1.TagsController.deleteTags,
)
