...
const getSizes = () => __awaiter(void 0, void 0, void 0, function* () {
    const sizes = yield prisma_1.default.size.findMany({});
    return sizes;
});
const editSize = (sizeData, id) => __awaiter(void 0, void 0, void 0, function* () {
    const size = yield prisma_1.default.size.update({ where: { id }, data: sizeData });
    return size;
});
