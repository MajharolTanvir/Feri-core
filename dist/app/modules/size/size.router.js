...
router.patch(
  ...
  (0, validateRequest_1.default)(
    size_validation_1.SizeValidation.updateSizeZodSchema,
  ),
  size_controller_1.SizeController.editSize,
)
...
router.delete(
  ...
  size_controller_1.SizeController.deleteSize,
)
router.post(
  '/',
  (0, auth_1.default)(
  ...
  (0, validateRequest_1.default)(
    size_validation_1.SizeValidation.createSizeZodSchema,
  ),
  size_controller_1.SizeController.addSize,
)
